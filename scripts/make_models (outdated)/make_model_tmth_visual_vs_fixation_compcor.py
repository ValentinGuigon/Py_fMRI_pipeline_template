...
# Output model JSON
OUT = Path("/data/sld/homes/vguigon/work/fitlins_models/tmth_visual_vs_fixation_compcor_smdl.json")

SUBJECTS = ["000", "001", "002", "003"]
TASKS = ["tm1", "tm2", "th1", "th2"]
...
# Events from your master TM/TH events.tsv
...
def main():
    ...
    model = {
        "Name": "tmthVisualVsFixationCompCor",
        "BIDSModelVersion": "1.0.0",
        "Description": (
            "TM/TH visual epochs (choice+wait+feedback) contrasted against fixation, "
    ...
    # Debug output
    print("DEBUG - Run node Model:", model["Nodes"][0]["Model"])
    print("DEBUG - Subject node Model:", model["Nodes"][1]["Model"])
    print("DEBUG - Dataset node Model:", model["Nodes"][2]["Model"])
